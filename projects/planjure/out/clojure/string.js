...
{{
var G__73806 = cljs.core.pop.call(null,v__$1);
v__$1 = G__73806;
continue;
}
} else
...
{var pred__73810 = cljs.core._EQ_;var expr__73811 = limit;if(cljs.core.truth_(pred__73810.call(null,1,expr__73811)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__73810.call(null,2,expr__73811)))
...
var G__73813 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__73814 = (limit__$1 - 1);
var G__73815 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__73813;
limit__$1 = G__73814;
parts = G__73815;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___73817 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___73817))
{var replacement_73818 = temp__4090__auto___73817;buffer.append([cljs.core.str(replacement_73818)].join(''));
} else
{buffer.append(ch);
}
{
var G__73819 = (index + 1);
index = G__73819;
continue;
}
}
